...
echo "Deploying date is 20160614 " | tee -a $LOGPATH/$LOG

exit
fi
if [ "${0##*/}" = "deploy_src_20160614.sh" ]
then
echo "*********************************************************************"
...
echo "Check your shell Program and Patch File  and shell file name is deploy_src_20160614.sh and Deploying date is 20160614" | tee -a $LOGPATH/$LOG

exit
fi
if [ -f "./curation_admin_patch_20160614.zip" ]
then
echo "*********************************************************************"

else
echo "Patch File Not Found : curation_admin_patch_20160614.zip " | tee -a $LOGPATH/$LOG
...
unzip -d curation_admin_patch_20160614 curation_admin_patch_20160614.zip | tee -a $LOGPATH/$LOG
...
cp -rfv ./curation_admin_patch_20160614/channel_sql.xml  /app/ctas/webroot/WEB-INF/classes/sqlmap/mappers/ | tee -a $LOGPATH/$LOG
mkdir -p /app/ctas/webroot/WEB-INF/view/channel | tee -a $LOGPATH/$LOG
cp -rfv ./curation_admin_patch_20160614/youtube_reg.jsp  /app/ctas/webroot/WEB-INF/view/channel/ | tee -a $LOGPATH/$LOG
mkdir -p /app/ctas/webroot/WEB-INF/classes/kr/co/wincom/curation/client/controller | tee -a $LOGPATH/$LOG
cp -rfv ./curation_admin_patch_20160614/ChannelController.class    /app/ctas/webroot/WEB-INF/classes/kr/co/wincom/curation/client/controller/ | tee -a $LOGPATH/$LOG
cp -rfv ./curation_admin_patch_20160614/ChannelController"$"*.class  /app/ctas/webroot/WEB-INF/classes/kr/co/wincom/curation/client/controller/ | tee -a $LOGPATH/$LOG
cp -rfv ./curation_admin_patch_20160614/program_topchannel.jsp  /app/ctas/webroot/WEB-INF/view/channel/ | tee -a $LOGPATH/$LOG
...
rm -rf curation_admin_patch_20160614 | tee -a $LOGPATH/$LOG
mv -f curation_admin_patch_20160614.zip $BACKUPPATH/curation_admin_patch_20160614.zip.bak | tee -a $LOGPATH/$LOG
mv -f deploy_src_20160614.sh $BACKUPPATH/deploy_src_20160614.sh.bak | tee -a $LOGPATH/$LOG
