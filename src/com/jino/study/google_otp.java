...
public class google_otp extends HttpServlet {
...
//      String url = getQRBarcodeURL(userName, hostName, secretKeyStr);
        ...
        String url = getQRBarcodeURL("123", "study.wincom.co.kr:8080/", encodedKey); // 생성된 바코드 주소!
        System.out.println("URL : " + url);
         
        String view = "/otp/otp_test.jsp";
