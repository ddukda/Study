...
{
  private static final String ENC_KEY = "bizringEnckPasswd";
  ...
  {
    return comEncMake.decrypt("bizringEnckPasswd", ref.get(idx).getContent().toString());
  }
