...
public class comEncFactory extends BasicDataSourceFactory
{
  private static final String ENC_KEY = "wincomCRPassword";
  ...
  private String decrypt(int idx, Reference ref)
    throws Exception
  {
    return comEncMake.decrypt("wincomCRPassword", ref.get(idx).getContent().toString());
  }
